import { Home, Search, Library, Plus, Shield, Music, Users, Settings, Sparkles, ExternalLink, Bot } from "lucide-react";
...
const navigationItems = [
  ...
  { title: "Bot Dashboard", url: "/bots", icon: Bot, testId: "link-bots" },
